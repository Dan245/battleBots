 ...
 * outside the <i>arena</i> package, and only the public information about the
 * bots
...
public class BotInfo {
	...
	/**
	 * @param lastMove The last move the bot made (see the constants in
	 *                 BattleBotArena)
	 */
	...
	/**
	 * @return The Bot's ID number. This will be a unique identifier between 0 and
	 *         BattleBotArea.NUM_BOTS - 1. Numbers change from round to round.
	 */
